...
class Index extends React.Component {
  ...
  showHideMenuEvent(data) {
    this.setState({showHideMenu: data});
  }

  render() {
    let showHideFirstChild = classNames({'first-child': true, 'open': this.state.showHideMenu});

    let showHideMenu = classNames({'menu-box': true, 'open': this.state.showHideMenu});
